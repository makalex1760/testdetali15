...
?> 
        <?endforeach?> 
<?if($admp) { $tooltip='tooltip'; $help=iconv('UTF-8', 'CP1251',"Спроси: Все ли заказано, и предложи оформить заказ."); } ?>
<a  class="<?=$tooltip?>" data-title="<?=$help?>" href="<?=$arParams["BASKET_URL"]?>"><?=GetMessage("YENISITE_BASKET_NAME")?>
