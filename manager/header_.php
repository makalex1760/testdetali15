...
<input type="radio" <?=$company?> name="type" value="company" id="company"><label for="company">Юридическое лицо</label>
  ...
  <input type="submit" name="submit" value="Сохранить"> 
	 ...
	 <?$APPLICATION->IncludeComponent("yenisite:catalog.basket.small", "basket_top", array(
			...
			<div class="header">
				<div id="headlogo">
					<a href="//detali15.ru/katalog/"><img src="//detali15.ru/img/detalimashin-moscow.jpg" name="logopic" height="60" id="logopic" border="0" /></a>
					Москва, ул. Коминтерна, д.20/2.
				</div>
				<div id="headbasket">
					<?$APPLICATION->IncludeComponent("yenisite:catalog.basket.small", "basket_top", array(
															"VALUTA" => "руб.",
				...
				<div id="headcenter">
					...
					<br>
					<a href="//detali15.ru/img/gaz-b-2019.PDF" target="_blank">Официальный сайт торгового представителя завода ГАЗ</a>
					<br>
	<? if($admp):?><span class='tooltip' data-title='Если Вы на нашем сайте назовите код товара'> <? endif; ?>					
					<?$APPLICATION->IncludeComponent("bitrix:search.title", "catalog_title_manager", array(
	"NUM_CATEGORIES" => "1",
	"TOP_COUNT" => "12",
	"ORDER" => "rank",
	...
	<? if($admp):?></span> <?endif;?>
				...
				<div id="headcontact">
					...
					<span id="phone">8(800) 500-7283</span>
					<br />
					Для Москвы:
					...
					<br />
					<!--<a href="http://detali15.ru/content/news/5/33651/"><b>График работы в новогодние праздники</b></a><br/>-->
