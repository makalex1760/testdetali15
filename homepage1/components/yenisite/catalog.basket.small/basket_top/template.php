...
<a  style="color:#fff; font-size:95%" class="<?=$tooltip?>" data-title="<?=$help?>" href="<?=$arParams["BASKET_URL"]?>" rel=nofollow ><?=GetMessage("YENISITE_BASKET_NAME")?>
<?=GetMessage("YENISITE_BASKET_BASKET")?>: <?=$total_count?><br/>
<?=GetMessage("YENISITE_BASKET_SUMM")?>:  <?=$total_price?> <?=$arParams['VALUTA']?>
</a>
