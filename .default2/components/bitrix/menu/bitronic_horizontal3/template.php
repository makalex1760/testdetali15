    ...
    <?foreach($arResult as $arItem):?>
        ...
        <?if ($arItem["IS_PARENT"]):?>
            <?if ($arItem["DEPTH_LEVEL"] == 1): $cnt++;?>
                <li <?if($cnt==$count) echo "class='last'";?> style="width: <?=100/$count;?>%"><a href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a>
        ...
        <?else:?>
            ...
            <?else:?>
                <?if ($arItem["DEPTH_LEVEL"] == 1): $cnt++;?>
                    ...
                    <?else:?>
                        <li <?if($cnt==$count) echo "class='last'";?> style="width: <?=100/$count;?>%">><a href="" title="<?=GetMessage("MENU_ITEM_ACCESS_DENIED")?>"><?=$arItem["TEXT"]?></a></li>
                    <?endif?>
                <?else:?>
