...
<div class="hproduct">
	<table id="3" width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
...
?>
<font color="#FF0000" face="Tahoma" size="3"><i><b>Ваша цена (<?=$discount["NAME"]?>): <?=$arResult["PROPERTIES"][$discount["CODE"]]["VALUE"]?> руб.</b></i></font><br>
...
<font color="#FF0000" face="Tahoma" size="3"><i><b>Розничная цена: <?=$arResult["PROPERTIES"]["PRICE_BASE"]["VALUE"]?> руб.</b></i></font>
...
<? } ?>
			...
			<?if($arParams["USE_PRODUCT_QUANTITY"] || count($arResult["PRODUCT_PROPERTIES"])):?>
				...
				<table id="4" border="0" cellspacing="0" cellpadding="2">
				<?if($arParams["USE_PRODUCT_QUANTITY"]):?>
					<tr valign="center">
						<td><?echo GetMessage("CT_BCE_QUANTITY")?>:</td>
						<td>
							<!--<input type="text" name="<?echo $arParams["PRODUCT_QUANTITY_VARIABLE"]?>" value="1" size="5">-->
                                                        <input type="text" name="quantity" value="1" size="2" style="width: 30px;" id="product_quantity<?=$arResult["ID"];?>">
						</td>
<td>
<p><input type="hidden" name="price" value="<?=$price?>" id="product_price<?=$arResult["ID"];?>">

<input type="button" class="add2basket" rel="<?=$arResult["ID"]?>" value=" Добавить в корзину ">
</p>								
