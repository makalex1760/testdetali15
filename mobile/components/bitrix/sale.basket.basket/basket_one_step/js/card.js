...
jQuery(document).ready(function() {
	...
	// Change person type
	jQuery(".PERSON_TYPE input").click(function(){
...
/*jQuery(".DELIVERY input").on('click change',function(){
	
	jQuery(".info-amount_ia").load(jQuery("#b_template_ia").val()+"/delivery.php",{'delivery_price':jQuery(this).attr('data-rel'), 'delivery':jQuery(this).val()},function(){b_loaded_ia(), preloader_stop_ia();});
	});	*/
	iargaInitProps();
...
iargaInitProps = function(){
	...
	jQuery(".DELIVERY input").change(function(){
