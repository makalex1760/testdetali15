							...
							?>
								...
								<td class="item">
									...
									<div class="bx_ordercart_itemart">
										<?
$db_props = CIBlockElement::GetProperty("4", $arItem[PRODUCT_ID], "sort", "asc");
  while($ar_props = $db_props->Fetch())
  {

  if($ar_props["VALUE"]&&$ar_props["CODE"]!='BLOG_POST_ID'&&$ar_props["CODE"]!='QTY1'&&$ar_props["CODE"]!='QTY2') { if($ar_props["VALUE_ENUM"])
      echo $ar_props["NAME"].": ".$ar_props["VALUE_ENUM"]."<br>";
							else
		echo $ar_props["NAME"].": ".$ar_props["VALUE"]."<br>";
						}
