...
if(isset($_POST['discount_code'])){
	...
	__($arCoupons,false,true);
	if($arCoupons){
	_c("test");	
	$_SESSION['discount']="Ваша скидка 10%";	
	$_SESSION['discount_val']="10";
	$_SESSION['discount_type'] = "P";
...
// discount
if(!isset($disc_price)) $disc_price = $price;_c($disc_price);
...
<p><span><span class="icon"><img src="<?=$template?>/images/icon-info-amount.png" alt=""></span><?=GetMessage("IN_BASKET")?> <strong><a href="#SITE_DIR#basket/" class="innerlink"><?=$num?></a></strong>&nbsp;<?=GetMessage(iarga::sklon($num,"GOODS","GOOD","2GOODS"))?>, <a href="#SITE_DIR#basket/"><?=iarga::prep($price)?><?=GetMessage("VALUTE_SMALL")?></span></a> 
<a class="bt_gray" href="#SITE_DIR#basket/"><?=GetMessage("VIEW")?></a></p>
...
<input type="hidden" name="valute" value="<?=GetMessage("VALUTE_SMALL")?>">
