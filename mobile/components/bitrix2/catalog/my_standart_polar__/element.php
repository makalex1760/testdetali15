...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"USER_GROUP" => "",
		"PERSON_FIELD_NAME" => "1",
		"PERSON_FIELD_EMAIL" => "20",
		"PERSON_FIELD_PHONE" => "3",
		"CUR_USER" => "1",
		"NOTICE_ADMIN_MAIL" => "Y",
		"NOTICE_ADMIN_MAIL_EMAIL" => "sale@polar18.ru",
		"NOTICE_ADMIN_MAIL_EVENT_MESSAGE_ID" => "44",
		"NOTICE_USER_MAIL" => "Y",
		"NOTICE_USER_MAIL_EVENT_MESSAGE_ID" => "42",
		"NOTICE_USER_MAIL_EVENT_MESSAGE_ID2" => "41"
	),
	false,
	array(
		"ACTIVE_COMPONENT" => "Y"
