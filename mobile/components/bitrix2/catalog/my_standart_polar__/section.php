...
if ($arParams['USE_FILTER'] == 'Y')
{
	...
	elseif ($obCache->StartDataCache())
	{
		...
		{
	$dbRes = CIBlockSection::GetList(array(), $arFilter, false, array("ID","UF_VIEW","UF_ABC","UF_DESC","UF_TOPDESC"));
...
if ($verticalGrid)
{
	?><div class="bx_content_section"><?if($arCurSection['UF_TOPDESC'])
    include $_SERVER["DOCUMENT_ROOT"].$arCurSection['UF_TOPDESC'];
}
?>
