...
<a  href="<?=$arElement[DETAIL_PAGE_URL]?>"  alt="<?=$arElement[PREVIEW_PICTURE][SRC]?>" ?><img src="<?=$arElement[PREVIEW_PICTURE][SRC]?>" width="50px" ></a>
...
<br/><span class="tooltip" data-title="<?echo$tooltip_text;?>"><?=$arElement["PROPERTIES"]["NALICHIE"]["VALUE"]?></span>
		...
		<td  class="row_dec2">
			...
			<?if($arElement["CAN_BUY"]):?>
				...
				<a class="buy-but" data-value="<? echo $arElement['ADD_URL'];?>">Купить</a>
