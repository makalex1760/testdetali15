...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"USER_GROUP" => "",
		"PERSON_FIELD_NAME" => "1",
		"PERSON_FIELD_EMAIL" => "1",
		"PERSON_FIELD_PHONE" => "3",
		"CUR_USER" => "1",
		"NOTICE_ADMIN_MAIL" => "Y",
		"NOTICE_ADMIN_MAIL_EMAIL" => "shop@auto-open.ru",
		"NOTICE_ADMIN_MAIL_EVENT_MESSAGE_ID" => "",
		"NOTICE_USER_MAIL" => "Y",
		"NOTICE_USER_MAIL_EVENT_MESSAGE_ID" => "",
		"NOTICE_USER_MAIL_EVENT_MESSAGE_ID2" => "",
