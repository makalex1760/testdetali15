...
<?  		
			...
			if($arOneProp['CODE']=='NALICHIE') { 	
				...
				?>	<tr >
					<td style="border-bottom:1px solid #ddd;width:150px;"><? echo $gr_nal; echo $prop_name; echo $obspan; ?></td>
					<td align="right" style="border-bottom:1px solid #ddd;"> <?	echo $prop_value; ?> </td>
					</tr>
...
></div>
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium" href="javascript:void(0)" rel="nofollow"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Добавить в корзину</a>
		</div>
			<?
			if ($arParams['DISPLAY_COMPARE'])
			{
				...
				<div class="bx_catalog_item_controls_blocktwo">
					<a id="<? echo $arItemIDs['COMPARE_LINK']; ?>" class="bx_bt_button_type_2 bx_medium" href="javascript:void(0)"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Добавить в корзину</a>
				</div><?
			}
		}
		else
