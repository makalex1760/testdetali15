...
<a  href="<?=$arElement[DETAIL_PAGE_URL]?>"  alt="<?=$arElement[PREVIEW_PICTURE][SRC]?>" ?><img src="<?=$arElement[PREVIEW_PICTURE][SRC]?>" width="30px" ></a>
		...
		<td  class="row_dec1">
			...
			case "есть в наличии":$tooltip_text="Открытое ш. 17 корп. 13";break;
			case "на складе":$tooltip_text="Доставка в течении 1-го рабочего дня";break;
			case "под заказ":$tooltip_text="Доставка в течении 10-ти рабочих дней";break;
			} ?>
...
<br/><span class="tooltip" data-title="<?echo$tooltip_text;?>"><?=$arElement["PROPERTIES"]["NALICHIE"]["VALUE"]?></span>
		...
		<td  class="row_dec2">
			...
			<?if($arElement["CAN_BUY"]):?>
				<noindex>
				<a class="basket_mini" href="<?echo $arElement["ADD_URL"]?>" ></a>
				</noindex>
